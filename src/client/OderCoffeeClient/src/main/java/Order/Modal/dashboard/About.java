...
public class About extends JPanel {
    ...
    private void init() {
        ...
        JTextPane title = createText("Order Coffee");
    ...
    private String getDescriptionText() {
        String text = "This is a demo project for the Modal Dialog library, " +
                ...
                "For source code, visit the <a href=\"https://github.com/HungPig/OderCoffeeClient\">GitHub Project.</a>";
    ...
    private JComponent createSystemInformation() {
        ...
        String version = OrderMain.DEMO_VERSION;
